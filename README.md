...
| Test Steps: | Test Data: | Expected Results: | Actual Results: | Status: |
| --- | --- | --- | --- | --- |
| 1. Go to the website glovoapp.com <br> 2. Close cookies <br> 3. Navigate to 'Get Started' button <br> 4. Choose Email login option <br> 5. Enter email <br> 6. Enter password <br> 7. Enter name <br> 8. Enter your location/address <br> 9. Navigate to a Food menu <br> 10. Choose Restaurants <br> 11.Click on KFC <br> 12. Click on 'Top Sellers ' <br> 13. Select desirable food <br> 14. Click on button 'Add to cart' <br> 15. Click on 'Order button' to continue with the order <br> 16. Click on 'Confirm address' to continue <br> 17. Click on' Go to Checkout' <br> 18.Click on 'Add phone number' <br> 19. Add a payment method, choose 'Pay with cash' <br> 20. Click on 'Confirm Order' <br> 21. Write the amount of cash and click 'Proceed' button <br> 22. After the completion of the order, the user is redirected to the homepage. | -'svvttest360@outlook.com' <br> -svvttest123 <br> -Aleja Lipa 66, 71000 Sarajevo <br> -'Tester' <br> -+3870001111 <br> -20 | Load website without any issues. Open a signup/login window. Email and password work successfully. Input location is successful. User is logged in. Open Food bubble, select Restaurants. Find desirable restaurant and desirable food from it. Proceed to order, confirm address. Add phone number, payment method, successfully order. | Website is loaded without any issues. Email and password fields are correct. Input of location is successful, and the user is logged in. The bubble is clickable, and it opens the list of options to select. The bubble is clickable, and it leads you to a new window with a list ofrestaurants. The field is clickable, and it opens the menu of KFC. The button is clickable, and it shows the list of top sellers. Button is clickable and it opens a pop-up to select the additions to the order, drinks, desserts and to select how many of it we want to order. Button is clickable, and it adds desirable items to the cart. Button is clickable and it opens a pop-up screen to check if everything is set. Button is clickable, and it opens a new screen to write about any allergies, if you need cutlery, to add a phone number, and a payment method. We can click and write the phone number. And here ends because it asks for verification code. | FAIL |

<b>Notes: </b><i>This test fails because it asks to input the verification code that we get on our phone.</i>

## 4. Conclusion

<b>4.1 Testing summary</b>
